/**
This program is for an organisation where there are part time and full time employees.
Part time employees can access and edit details of customers.
Regular emplyoee add attendance of part time employees.
The head calculates salary of all the employee
*/
#include <iostream>
#include <cstring>
using namespace std;
...
class PartTime : public Employee            //Public Inheritance
{
public:
    void display()
    {
...
class Fin{
 ...
 void input_reg(int a){
    ...
    Fin operator+(Fin a){                       //Operator overloading
        Fin sum;
 ...
 class customer{
   ...
   ~customer();
    ...
    friend void getval(customer &o);            //Friend Function
    
 };
 customer:: customer(){                         //Scope Resolution & Constructor
        cout<<"Constructor Called";
        amt=0;
    }
 customer:: ~customer(){                        //Scope Resolution & Destructor
        cout<<"Destructor Called";
    }
 void getval(customer &o){
